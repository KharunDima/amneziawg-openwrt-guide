...
## 🎬 Перед началом: Требования к системе
Перед запуском сборки убедитесь, что ваша система соответствует минимальным требованиям.

**Рекомендуемая операционная система:**

- Ubuntu 22.04 / 23.10 или новее

- Debian 12 / 13 (Bookworm / Trixie)

- Другие дистрибутивы на основе Debian

**Требования к дисковому пространству:**

- **Минимум:** 15 ГБ свободного места

- **Рекомендуется:** 25-30 ГБ для комфортной работы и кэша сборки

**Производительность:**

- Чем больше ядер (CPU) и оперативной памяти (RAM), тем быстрее пройдет сборка. Минимум — 2 ядра и 4 ГБ ОЗУ.

## 📦 Установка зависимостей
Сборка OpenWrt требует множества инструментов и библиотек. Установите их все одной командой перед началом.
...
Найдите эквивалентные пакеты в вашем менеджере пакетов. Основные группы: gcc, make, binutils, python3, git, libncurses, openssl.
...
- Save - сохранит ваш .config
   
- Load - загрузит ваш .config
...
После выбора пакетов сделайте:   Save - .config
...
**kmod-пакеты из официального репозитория OpenWrt не установятся!**
